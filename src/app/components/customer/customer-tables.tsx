            ...
            <table className="w-full text-base text-left text-gray-500 ">
              <thead>
                <tr className="border-b border-gray6 text-tiny">
                  ...
                  <th
                    scope="col"
                    className="px-3 py-3 text-tiny text-text2 uppercase font-semibold w-[150px] text-start"
                  >
                    Shipping
                  </th>
                  <th
                ...
                {filteredItems.map((item: ItemType) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 font-normal text-[#55585B] text-start">
                      ...
                      item.status =='active' && <span className="p-3 leading-10 text-tiny bg-yellow text-white rounded-md hover:bg-cyan-700 cursor-pointer">Active</span>

                      }
                      {

item.status =='inactive' && <span className="p-3 leading-10 text-tiny bg-red text-white rounded-md hover:bg-red cursor-pointer">InActive</span>

}
{

item.status =='blocked' && <span className="p-3 leading-10 text-tiny bg-danger text-white rounded-md hover:bg-danger cursor-pointer">
  Blocked</span>
