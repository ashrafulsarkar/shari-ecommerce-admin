...
import { useDeleteAlbumMutation } from "@/redux/album/albumApi";
...
const AlbumEditDelete = ({ id }: IPropType) => {
  const [showEdit, setShowEdit] = useState<boolean>(false);
  const [showDelete, setShowDelete] = useState<boolean>(false);
  const router = useRouter()
  const [deleteAlbum, { data: delData, error: delErr }] =
...
export default AlbumEditDelete;
